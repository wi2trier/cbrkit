...
def to_dict[K, N, E, G](g: Graph[K, N, E, G]

) -> SerializedGraph[K, N, E, G]:
return g.to_dict()


def from_dict[K, N, E, G](g: SerializedGraph[K, N, E, G]
...
try:
    ...
    def to_rustworkx[N, E](g: Graph[Any, N, E, Any]

    ) -> "rustworkx.PyDiGraph[N, E]":
...
def from_rustworkx[N, E](g: "rustworkx.PyDiGraph[N, E]"
...
try:
    ...
    def to_networkx[N, E](g: Graph[Any, N, E, Any]
...
def from_networkx[N, E](g: "nx.DiGraph"
