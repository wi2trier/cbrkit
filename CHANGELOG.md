...
* **indexable:** apply conversion functions off the event loop ([701135e](https://github.com/wi2trier/cbrkit/commit/701135ec469a09165438a547359cd9c00d18cc5e))
...
* add index property to function protocol ([b554f37](https://github.com/wi2trier/cbrkit/commit/b554f370afcca9ad592a2d204067271626224d2d))
* add initial support for revise and retain ([58b836a](https://github.com/wi2trier/cbrkit/commit/58b836ab2fcbb8166876d67418d39c83029a4360))
* add support for batched adaptation functions ([80a1335](https://github.com/wi2trier/cbrkit/commit/80a1335a98c0fecb3059d7e501aa2907ab436cf7))
* add support for zvec ([185f54b](https://github.com/wi2trier/cbrkit/commit/185f54b2c2e3c2768615ba35e2161040392f5dcc))
* **embed:** add sparse vectors via splade and bm25 ([06a2933](https://github.com/wi2trier/cbrkit/commit/06a293396e33a635602bc3a99f997c32e9622221))
* **embed:** generalize splade to sparse encoder ([f282ae0](https://github.com/wi2trier/cbrkit/commit/f282ae034abf791a7c2965ea069a787ef75175a5))
* extend indexable with keys and values properties ([cb79df6](https://github.com/wi2trier/cbrkit/commit/cb79df67313d59fcf5c07685aa5ce042a60a6c59))
* **indexable:** intelligently update existing data ([900a23a](https://github.com/wi2trier/cbrkit/commit/900a23acc75c284302fc51a92ad19a6a60f02e9b))
* **retieval/lancedb:** add full text search ([5a153f2](https://github.com/wi2trier/cbrkit/commit/5a153f2c528d3d733da510ea6a73801cc4029623))
* **retrieval:** add support for chromadb ([34b4c6c](https://github.com/wi2trier/cbrkit/commit/34b4c6caf78328187490ed149a80f1f8c78fef64))
* **retrieval:** initial support for lancedb ([3caf329](https://github.com/wi2trier/cbrkit/commit/3caf329daff8e0d96959f936ea3ea8b2fcb32e89))
* **retrieval:** rename stateful to persist and support file operations ([2ff4c1b](https://github.com/wi2trier/cbrkit/commit/2ff4c1bd4f6e20c6aaeb6b9a797e7729f082f805))
* **retrieval:** update interface to allow returning case bases ([54773b1](https://github.com/wi2trier/cbrkit/commit/54773b193313415463930e68ff28df4c476ac76a))
* separate indexable storage from retrieval ([1a27dfc](https://github.com/wi2trier/cbrkit/commit/1a27dfca8716c8f6991ea6af2567224944f77f00))
* set python 3.13 as minimum version ([f7b2bcd](https://github.com/wi2trier/cbrkit/commit/f7b2bcd36b32d923cb3b5d02a080b3081e5299a1))
* update signature of indexable functions ([3cc19fa](https://github.com/wi2trier/cbrkit/commit/3cc19fa78f53f2cab5902714f0f2cfbb8060f581))

### Bug Fixes

* address basedpyright errors ([63269cd](https://github.com/wi2trier/cbrkit/commit/63269cdc745f30f5cb9c37d43d50c05b5ff29a2b))
* address ty errors ([09edf1b](https://github.com/wi2trier/cbrkit/commit/09edf1b336f4cb8c703d1059cd76d0f5f126c60e))
* align indexable behavior ([c222488](https://github.com/wi2trier/cbrkit/commit/c22248852bddeabde75d69bb749fca557ffb6f79))
* enable prune by default ([69c85f7](https://github.com/wi2trier/cbrkit/commit/69c85f7073663c42dd2df3a02dff2cbd42d83598))
* **eval:** properly compute kendall tau and add doctests ([edf0014](https://github.com/wi2trier/cbrkit/commit/edf001492260aeffbdd7cbf7ef6d21dc383d219e))
* **helpers/dispatch:** make sure empty casebases are jointly processed ([ba7555b](https://github.com/wi2trier/cbrkit/commit/ba7555b097b4bc92f8f2a9de88b1c01275a8d6b3))
* **helpers:** improve optional dependencies import ([ea704d2](https://github.com/wi2trier/cbrkit/commit/ea704d21849a07cf882f4b50f5050e61a9257c83))
* **indexable:** add has_index method ([06c238e](https://github.com/wi2trier/cbrkit/commit/06c238ee97c5ebc18ee885716ebf7138c2e81ea3))
* **indexable:** add storage delegator mixin ([35a84b4](https://github.com/wi2trier/cbrkit/commit/35a84b4c9e03044e2001eb3c0da248f97ca5eb52))
* **indexable:** set default for delete type ([86a3847](https://github.com/wi2trier/cbrkit/commit/86a3847ecf500bfc519eef7b84257c5872479c0b))
* **loaders/sql:** dispose engine properly ([f90ae4a](https://github.com/wi2trier/cbrkit/commit/f90ae4a7b76d86482410224633955ae5977ce6d6))
* optimize package extras ([ffd497d](https://github.com/wi2trier/cbrkit/commit/ffd497daab72c497c2df84f340e3466563b2edb5))
* remove auto_index parameter from embed and bm25 ([358ad8d](https://github.com/wi2trier/cbrkit/commit/358ad8dcdd675cf640745194be41a66b9b7532d1))
* remove json dereferencing after fastmcp update ([f2fa1a3](https://github.com/wi2trier/cbrkit/commit/f2fa1a3328ec2ef391f200346defd3d40da9d1cf))
* resolve circular imports and other type issues ([89a96fe](https://github.com/wi2trier/cbrkit/commit/89a96fecf3431a58ed6308f8fc9dbe4637e0d5db))
* **retain:** add indexable wrapper ([e2fd531](https://github.com/wi2trier/cbrkit/commit/e2fd531ebba362427a034cbaf61dbfbaeba2c9f2))
* **retain:** add static helper and extract key func as first-class type ([fb8fae6](https://github.com/wi2trier/cbrkit/commit/fb8fae6ddcc1f3364c89f3410b9e3e2123367ec7))
* **retain:** remove unneeded auto_key storage ([1f126df](https://github.com/wi2trier/cbrkit/commit/1f126df4398e6ac0677b0a6ef7661e0dbf7a937f))
* **retain:** store cases and not query ([f50ccf6](https://github.com/wi2trier/cbrkit/commit/f50ccf6eec3daaefa5150203ba72d74db0191510))
* **retrieval/bm25:** handle potential zero division ([5a56315](https://github.com/wi2trier/cbrkit/commit/5a56315f26005ea7bd7ef1bc1bdfc462bd2f1447))
* **retrieval/bm25:** require frozendict for indexing ([ce6a800](https://github.com/wi2trier/cbrkit/commit/ce6a8001288aa23a1b7d2ec9fb73bb28fe12e46b))
* **retrieval/bm25:** support empty casebases ([e2526c3](https://github.com/wi2trier/cbrkit/commit/e2526c30c4f969db579b36f1bd0159d4972f2962))
* **retrieval/embed:** add missing init and allow batch similarity func ([0247abe](https://github.com/wi2trier/cbrkit/commit/0247abe8746ca38a8faf33ad8b31187de404ce12))
* **retrieval/lancedb:** add limit ([894e022](https://github.com/wi2trier/cbrkit/commit/894e02262c245763fd58199196677f82e3f9367c))
* **retrieval/lancedb:** allow further customization ([ecc3d84](https://github.com/wi2trier/cbrkit/commit/ecc3d843f0e0debc247d6fc57b83531e0bb0cb62))
* **retrieval:** add embed wrapper ([d702a39](https://github.com/wi2trier/cbrkit/commit/d702a39dcf510d1e55be7006bf84be1f583c5630))
* **retrieval:** add helpers to apply indexable functions ([31f6872](https://github.com/wi2trier/cbrkit/commit/31f6872c27c47b0d7b8dedba6e71550c88fc1cac))
* **retrieval:** add IndexableRetrieverFunc ([99cd519](https://github.com/wi2trier/cbrkit/commit/99cd519e51b83ad8a91c791b35bd6b3f9d475c0b))
* **retrieval:** add stateful wrapper ([ccb2390](https://github.com/wi2trier/cbrkit/commit/ccb23909b50ec494e411aba4eb4772cabf9e7ea7))
* **retrieval:** add support for empty casebases to helper methods ([b7848e8](https://github.com/wi2trier/cbrkit/commit/b7848e83442d8de9bccf0db9dc2060f1b92431d4))
* **retrieval:** handle empty casebases centrally ([8c781de](https://github.com/wi2trier/cbrkit/commit/8c781de2faa114bf0f36087f5b2a280cda304f6e))
* **retrieval:** make indexable retrievers share more code ([661f231](https://github.com/wi2trier/cbrkit/commit/661f2314013f0a1f86c22f55edf42c5d0abfa023))
* **retrieval:** minor improvements ([9d3f49d](https://github.com/wi2trier/cbrkit/commit/9d3f49db1315e2a3cbf4ded75e045a54c918348e))
* **reuse:** accept sim func instead of retriever func ([ff9f19f](https://github.com/wi2trier/cbrkit/commit/ff9f19fabff497198c12380162115365c7b1ae2c))
* **reuse:** migrate to new retriever pattern ([cea4f74](https://github.com/wi2trier/cbrkit/commit/cea4f74f4cf6a217251bea860c51ec33e01f8dd8))
* **sim/embed:** compute missing vectors if needed ([f3a0fae](https://github.com/wi2trier/cbrkit/commit/f3a0fae4d68e92346369e83d892833d64e78c6d0))
* **sim/embed:** improve caching of updates ([35686d2](https://github.com/wi2trier/cbrkit/commit/35686d2200d3b78364a4daa760cd408d643a2c19))
* **sim/graphs:** remove precompute function due to indexing support ([c7ee675](https://github.com/wi2trier/cbrkit/commit/c7ee675336d1ef05a5c8cb1a13acbb81cd99a6c1))
* simplify indexable function protocol ([c35919a](https://github.com/wi2trier/cbrkit/commit/c35919a9d4b6d5588e4a79464fb3413ec0808595))
* **system:** support empty casebases ([1ad994c](https://github.com/wi2trier/cbrkit/commit/1ad994c9bf02afd58e06ee8a46ca9db46cfe0486))
* **typing:** add prune parameter to indexable functions ([de0cec8](https://github.com/wi2trier/cbrkit/commit/de0cec83552b1eb52d1c512e6cd291ec1f4fc3ad))
